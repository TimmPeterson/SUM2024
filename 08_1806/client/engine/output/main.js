(function () {
    ...
    const host = "localhost";//"192.168.30.117";
    const port = "8000";
    let userName;
    let playersPool = {};
    let mainRender;
